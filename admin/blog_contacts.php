                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" data-toggle="modal" data-target="#delete_contact<?php echo $row['n_contact_id'] ?>" class="btn btn-default">Delete</button>
                                            </td>
                                                    ...
                                                    <div class="modal-dialog">                                                        
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">                                      
                                                                    <h2>Do you wanna delete this Contact ?</h2>                                                
                                                            </div>
